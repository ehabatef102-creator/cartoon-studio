...
OUTLINE_PROMPT = (
    ...
    "7) أسماء الشخصيات الواردة في المذكرة نهائية — استخدمها حرفيًا ولا تستبدلها بوصف (مثل 'كلب أليف' بدل اسمه).\n"
    + _length_directive()
)
...
SCENES_BATCH_PROMPT = (
    ...
    "أسماء الشخصيات الواردة في المذكرة نهائية — لا تستبدلها بوصف عام، "
    "design_prompt وimage_prompt بالحروف اللاتينية (English) حصرًا."
    + _length_directive()
)
